...
"""managing data into proper format"""
from sklearn.preprocessing import LabelEncoder
df2 = pd.DataFrame()
df2["Text"] = traindf["detokenized"]
df2["Label"] = LabelEncoder().fit_transform(traindf['Label'])
df2.tail()
...
label_list = [str(num) for num in range(df2['Label'].nunique())]
